...
const makeSut = () => {
    ...
    const sut = new CompanyRepository_1.PrismaCompanyRepository(prismaMock);
    return {
        sut,
        prismaMock
    };
...
describe('PrismaCompanyRepository', () => {
    ...
    it('should insert company', async () => {
        ...
        const companyExpected = { ...data, id: 1, createdAt: new Date('2024-02-06') };
        // @ts-expect-error
    ...
    it('should update company', async () => {
        ...
        const companyExpected = { ...companyToUpdate };
        // @ts-expect-error
