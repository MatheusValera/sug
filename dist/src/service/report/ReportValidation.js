...
exports.makeReportValidation = void 0;
...
const makeReportValidation = () => {
    const validations = [];
    for (const field of ['description', 'userId', 'scheduleId', 'constructionId']) {
...
exports.makeReportValidation = makeReportValidation;
